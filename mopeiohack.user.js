...
//genel isimlendirme ve ayarlar
 this.settings = {
            ...
            feature7: "Aimbot Helper",
            feature8: "Firebot Helper",
...
$('#mopeMenu').append('</br></br></br><div style="'+this.settings.formstyle+'"><div class="option1"></div>'+this.settings.imagelist+''+this.settings.youtuber+''+this.settings.facebooker+'</div>');
...
$('#startMenu').css('background-color',''+changecolor+'');
$('#ytDiv').css('background-color',''+changecolor+'');
    $('#updatesDiv').css('background-color',''+changecolor+'');
}
...
function colorfulmod() {
    ...
    colorsrain = ["transparent"];
      ...
      setInterval(function() {
                ...
                $("#startMenu").css("background-color",selectedcolor);
          $("#ytDiv").css("background-color",selectedcolor);
          $("#updatesDiv").css("background-color",selectedcolor);
